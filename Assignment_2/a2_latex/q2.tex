...
\begin{parts}
    ...
    \part[4] Adam Optimizer\newline
        ...
        \begin{subparts}
            ...
            \textcolor{blue}{
                \textbf{Solution}
            The gradients can be noisy in high dimensions. Therefore, keeping a moving average of gradients is like having a "low-pass filter". Instead of reacting strongly to noisy minibatch gradients, the update direction is smoothed towards the average trend. This low variance helps learning because it allows more consistent movement in promising directions, avoiding oscillations and making convergence faster and more stable.
            }
            \newline
            ...
            \textcolor{blue}{
                \textbf{Solution}
                Diving by $\sqrt{\bv_{t+1}}$ means coordinates with smaller $\bv$ coordinates, thus smaller gradients, will get scaled up. This helps the parameters that are in the "flat" regions of parameter space to move around and explore. The parameters with larger gradients are scaled down to avoid overshooting. 
            } \newline
